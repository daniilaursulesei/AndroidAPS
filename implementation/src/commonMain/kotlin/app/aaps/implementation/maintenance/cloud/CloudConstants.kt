...
object CloudConstants {
    ...
    // Automatic error reports are kept apart from the logs a user exported by hand, so a
    // night of faults cannot bury the export somebody went looking for.
    const val CLOUD_PATH_ERROR_LOGS = "${CLOUD_PATH_LOGS}/errors"
